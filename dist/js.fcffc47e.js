...
new _vue.default({
  ...
  methods: {
    ...
    addProductToComparision: function addProductToComparision(product) {
      this.compareProducts.push(product);
      console.log(this.compareProducts);
    },
    deleteFromCompare: function deleteFromCompare(compareProduct) {
  ...
  computed: {
    ...
    pagingPages: function pagingPages() {
      var pages = Math.ceil(this.foundProducts.length / 4);
      return Array.from({
        length: pages
      }, function (v, k) {
        return k;
    ...
    matchDivsToPage: function matchDivsToPage() {
      var startIndex = this.page * 4;
      var endIndex = this.page * 4 + 4;
